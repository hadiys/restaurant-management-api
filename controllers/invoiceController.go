...
func GetInvoices() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "An error occurred while listing invoices"})
		}
...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err!=nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "An error occurred while listing invoive item"})
		}
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		invoice.Payment_due_date, _ = time.Parse(time.RFC3339, time.Now().AddDate(0, 1, 1).Format(time.RFC3339))
